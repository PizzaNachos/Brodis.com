...
function toggleLightMode(){
    if(lightmode == false){
        ...
        document.documentElement.style.cssText = "--main-bg-color: rgb(235, 235, 235);"+
        ...
        document.documentElement.style.cssText = "--main-bg-color: rgb(15,15,15); --main-light-grey: rgb(30, 30, 30);" +
